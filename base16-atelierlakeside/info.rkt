...
;; color scheme
(define base00 #(22 27 29))
(define base01 #(31 41 46))
(define base02 #(81 109 123))
(define base03 #(90 123 140))
(define base04 #(113 149 168))
(define base05 #(126 162 180))
(define base06 #(193 228 246))
(define base07 #(235 248 255))
(define base08 #(210 45 114))
(define base09 #(147 92 37))
(define base0A #(138 138 15))
...
(define framework:color-schemes
  `(#hash((name . "Base16 Atelier Lakeside Dark")
    ...
    #hash((name . "Base16 Atelier Lakeside Light")
