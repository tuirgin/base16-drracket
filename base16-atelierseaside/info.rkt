...
;; color scheme
(define base00 #(19 21 19))
(define base01 #(36 41 36))
(define base02 #(94 110 94))
(define base03 #(104 125 104))
(define base04 #(128 153 128))
(define base05 #(140 166 140))
(define base06 #(207 232 207))
(define base07 #(240 255 240))
(define base08 #(230 25 60))
(define base09 #(135 113 29))
(define base0A #(195 195 34))
(define base0B #(41 163 41))
(define base0C #(25 153 179))
(define base0D #(61 98 245))
(define base0E #(173 43 238))
(define base0F #(230 25 195))

(define framework:color-schemes
  `(#hash((name . "Base16 Atelier Seaside Dark")
    ...
    #hash((name . "Base16 Atelier Seaside Light")
