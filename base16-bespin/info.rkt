...
;; color scheme
(define base00 #(40 33 28))
(define base01 #(54 49 46))
(define base02 #(94 93 92))
(define base03 #(102 102 102))
(define base04 #(121 121 119))
(define base05 #(138 137 134))
(define base06 #(157 155 151))
(define base07 #(186 174 158))
(define base08 #(207 106 76))
(define base09 #(207 125 52))
(define base0A #(249 238 152))
(define base0B #(84 190 13))
(define base0C #(175 196 219))
(define base0D #(94 166 234))
(define base0E #(155 133 157))
(define base0F #(147 113 33))

(define framework:color-schemes
  `(#hash((name . "Base16 Bespin Dark")
