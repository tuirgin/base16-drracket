...
;; color scheme
(define base00 #(0 0 0))
(define base01 #(48 48 48))
(define base02 #(80 80 80))
(define base03 #(176 176 176))
(define base04 #(208 208 208))
(define base05 #(224 224 224))
(define base06 #(245 245 245))
(define base07 #(255 255 255))
(define base08 #(251 1 32))
(define base09 #(252 109 36))
(define base0A #(253 163 49))
(define base0B #(161 198 89))
(define base0C #(118 199 183))
(define base0D #(111 179 210))
(define base0E #(211 129 195))
(define base0F #(190 100 60))

(define framework:color-schemes
  `(#hash((name . "Base16 Bright Dark")
