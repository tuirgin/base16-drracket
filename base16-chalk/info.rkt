...
;; color scheme
(define base00 #(21 21 21))
(define base01 #(32 32 32))
(define base02 #(48 48 48))
(define base03 #(80 80 80))
(define base04 #(176 176 176))
(define base05 #(208 208 208))
(define base06 #(224 224 224))
(define base07 #(245 245 245))
(define base08 #(251 159 177))
(define base09 #(237 169 135))
(define base0A #(221 178 111))
(define base0B #(172 194 103))
(define base0C #(18 207 192))
(define base0D #(111 194 239))
(define base0E #(225 163 238))
(define base0F #(222 175 143))

(define framework:color-schemes
  `(#hash((name . "Base16 Chalk Dark")
