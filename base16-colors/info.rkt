...
;; color scheme
(define base00 #(17 17 17))
(define base01 #(51 51 51))
(define base02 #(85 85 85))
(define base03 #(119 119 119))
(define base04 #(153 153 153))
(define base05 #(187 187 187))
(define base06 #(221 221 221))
(define base07 #(255 255 255))
(define base08 #(255 65 54))
(define base09 #(255 133 27))
(define base0A #(255 220 0))
(define base0B #(46 204 64))
(define base0C #(127 219 255))
(define base0D #(0 116 217))
(define base0E #(177 13 201))
(define base0F #(133 20 75))

(define framework:color-schemes
  `(#hash((name . "Base16 Colors Dark")
