...
(define base08 #(172 65 66))
(define base09 #(210 132 69))
(define base0A #(244 191 117))
(define base0B #(144 169 89))
(define base0C #(117 181 170))
(define base0D #(106 159 181))
(define base0E #(170 117 159))
(define base0F #(143 85 54))

(define framework:color-schemes
  `(#hash((name . "Base16 Default Dark")
    ...
    #hash((name . "Base16 Default Light")
