...
;; color scheme
(define base00 #(24 24 24))
(define base01 #(40 40 40))
(define base02 #(56 56 56))
(define base03 #(88 88 88))
(define base04 #(184 184 184))
(define base05 #(216 216 216))
(define base06 #(232 232 232))
(define base07 #(248 248 248))
(define base08 #(171 70 66))
(define base09 #(220 150 86))
(define base0A #(247 202 136))
(define base0B #(161 181 108))
(define base0C #(134 193 185))
(define base0D #(124 175 194))
(define base0E #(186 139 175))
(define base0F #(161 105 70))
