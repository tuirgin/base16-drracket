...
;; color scheme
(define base00 #(45 45 45))
(define base01 #(57 57 57))
(define base02 #(81 81 81))
(define base03 #(116 115 105))
(define base04 #(160 159 147))
(define base05 #(211 208 200))
(define base06 #(232 230 223))
(define base07 #(242 240 236))
(define base08 #(242 119 122))
(define base09 #(249 145 87))
(define base0A #(255 204 102))
(define base0B #(153 204 153))
(define base0C #(102 204 204))
(define base0D #(102 153 204))
(define base0E #(204 153 204))
(define base0F #(210 123 83))

(define framework:color-schemes
  `(#hash((name . "Base16 Eighties Dark")
    ...
    #hash((name . "Base16 Eighties Light")
