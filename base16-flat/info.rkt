...
;; color scheme
(define base00 #(44 62 80))
(define base01 #(52 73 94))
(define base02 #(127 140 141))
(define base03 #(149 165 166))
(define base04 #(189 195 199))
(define base05 #(224 224 224))
(define base06 #(245 245 245))
(define base07 #(236 240 241))
(define base08 #(231 76 60))
(define base09 #(230 126 34))
(define base0A #(241 196 15))
(define base0B #(46 204 113))
(define base0C #(26 188 156))
(define base0D #(52 152 219))
(define base0E #(155 89 182))
(define base0F #(190 100 60))

(define framework:color-schemes
  `(#hash((name . "Base16 Flat Dark")
