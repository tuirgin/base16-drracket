...
(define base02 #(55 59 65))
(define base03 #(150 152 150))
(define base04 #(180 183 180))
(define base05 #(197 200 198))
(define base06 #(224 224 224))
(define base07 #(255 255 255))
(define base08 #(204 52 43))
(define base09 #(249 106 56))
(define base0A #(251 169 34))
(define base0B #(25 136 68))
(define base0C #(57 113 237))
(define base0D #(57 113 237))
(define base0E #(163 106 199))
(define base0F #(57 113 237))

(define framework:color-schemes
  `(#hash((name . "Base16 Google Dark")
