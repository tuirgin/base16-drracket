...
;; color scheme
(define base00 #(11 28 44))
(define base01 #(34 59 84))
(define base02 #(64 92 121))
(define base03 #(98 126 153))
(define base04 #(170 188 206))
(define base05 #(203 214 226))
(define base06 #(229 235 241))
(define base07 #(247 249 251))
(define base08 #(191 139 86))
(define base09 #(191 191 86))
(define base0A #(139 191 86))
(define base0B #(86 191 139))
(define base0C #(86 139 191))
(define base0D #(139 86 191))
(define base0E #(191 86 139))
(define base0F #(191 86 86))

(define framework:color-schemes
  `(#hash((name . "Base16 harmonic16 Dark")
    ...
    #hash((name . "Base16 harmonic16 Light")
