...
(define base02 #(96 96 96))
(define base03 #(128 128 128))
(define base04 #(192 192 192))
(define base05 #(208 208 208))
(define base06 #(224 224 224))
(define base07 #(255 255 255))
(define base08 #(255 0 0))
(define base09 #(255 153 0))
(define base0A #(255 0 153))
(define base0B #(51 255 0))
(define base0C #(0 255 255))
(define base0D #(0 102 255))
(define base0E #(204 0 255))
(define base0F #(51 0 255))

(define framework:color-schemes
  `(#hash((name . "Base16 Isotope Dark")
    ...
    #hash((name . "Base16 Isotope Light")
