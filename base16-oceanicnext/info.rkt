...
;; color scheme
(define base00 #(27 43 52))
(define base01 #(52 61 70))
(define base02 #(79 91 102))
(define base03 #(101 115 126))
(define base04 #(167 173 186))
(define base05 #(192 197 206))
(define base06 #(205 211 222))
(define base07 #(216 222 233))
(define base08 #(236 95 103))
(define base09 #(249 145 87))
(define base0A #(250 200 99))
(define base0B #(153 199 148))
(define base0C #(95 179 179))
(define base0D #(102 153 204))
(define base0E #(197 148 197))
(define base0F #(171 121 103))

(define framework:color-schemes
  `(#hash((name . "Base16 OceanicNext Dark")
    ...
    #hash((name . "Base16 OceanicNext Light")
