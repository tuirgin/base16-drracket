...
;; color scheme
(define base00 #(6 18 41))
(define base01 #(42 52 72))
(define base02 #(77 86 102))
(define base03 #(113 120 133))
(define base04 #(154 153 163))
(define base05 #(184 187 194))
(define base06 #(219 221 224))
(define base07 #(255 255 255))
(define base08 #(208 115 70))
(define base09 #(240 160 0))
(define base0A #(251 212 97))
(define base0B #(153 191 82))
(define base0C #(114 185 191))
(define base0D #(82 153 191))
(define base0E #(153 137 204))
(define base0F #(176 128 96))

(define framework:color-schemes
  `(#hash((name . "Base16 PhD Dark")
