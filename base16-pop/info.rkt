...
(define base08 #(235 0 138))
(define base09 #(242 147 51))
(define base0A #(248 202 18))
(define base0B #(55 179 73))
(define base0C #(0 170 187))
(define base0D #(14 90 148))
(define base0E #(179 30 141))
(define base0F #(122 45 0))

(define framework:color-schemes
  `(#hash((name . "Base16 Pop Dark")
