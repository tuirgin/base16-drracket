...
;; color scheme
(define base00 #(21 23 24))
(define base01 #(142 196 61))
(define base02 #(59 117 140))
(define base03 #(65 83 91))
(define base04 #(67 165 213))
(define base05 #(214 214 214))
(define base06 #(238 238 238))
(define base07 #(255 255 255))
(define base08 #(205 63 69))
(define base09 #(219 123 85))
(define base0A #(230 205 105))
(define base0B #(159 202 86))
(define base0C #(85 219 190))
(define base0D #(85 181 219))
(define base0E #(160 116 196))
(define base0F #(138 85 63))

(define framework:color-schemes
  `(#hash((name . "Base16 Seti UI Dark")
    ...
    #hash((name . "Base16 Seti UI Light")
