...
;; color scheme
(define base00 #(0 43 54))
(define base01 #(7 54 66))
(define base02 #(88 110 117))
(define base03 #(101 123 131))
(define base04 #(131 148 150))
(define base05 #(147 161 161))
(define base06 #(238 232 213))
(define base07 #(253 246 227))
(define base08 #(220 50 47))
(define base09 #(203 75 22))
(define base0A #(181 137 0))
(define base0B #(133 153 0))
(define base0C #(42 161 152))
(define base0D #(38 139 210))
(define base0E #(108 113 196))
(define base0F #(211 54 130))

(define framework:color-schemes
  `(#hash((name . "Base16 Solarized Dark")
    ...
    #hash((name . "Base16 Solarized Light")
