...
(define base08 #(255 0 134))
(define base09 #(253 137 0))
(define base0A #(171 168 0))
(define base0B #(0 201 24))
(define base0C #(31 170 170))
(define base0D #(55 119 230))
(define base0E #(173 0 161))
(define base0F #(204 102 51))

(define framework:color-schemes
  `(#hash((name . "Base16 Summerfruit Dark")
    ...
    #hash((name . "Base16 Summerfruit Light")
