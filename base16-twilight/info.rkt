...
;; color scheme
(define base00 #(30 30 30))
(define base01 #(50 53 55))
(define base02 #(70 75 80))
(define base03 #(95 90 96))
(define base04 #(131 129 132))
(define base05 #(167 167 167))
(define base06 #(195 195 195))
(define base07 #(255 255 255))
(define base08 #(207 106 76))
(define base09 #(205 168 105))
(define base0A #(249 238 152))
(define base0B #(143 157 106))
(define base0C #(175 196 219))
(define base0D #(117 135 166))
(define base0E #(155 133 157))
(define base0F #(155 112 63))

(define framework:color-schemes
  `(#hash((name . "Base16 Twilight Dark")
    ...
    #hash((name . "Base16 Twilight Light")
