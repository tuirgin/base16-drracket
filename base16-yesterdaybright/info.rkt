...
(define base08 #(213 78 83))
(define base09 #(231 140 69))
(define base0A #(231 197 71))
(define base0B #(185 202 74))
(define base0C #(112 192 177))
(define base0D #(122 166 218))
(define base0E #(195 151 216))
(define base0F #(154 128 109))

(define framework:color-schemes
  `(#hash((name . "Base16 Yesterday Bright Dark")
    ...
    #hash((name . "Base16 Yesterday Bright Light")
